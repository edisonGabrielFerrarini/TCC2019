...
<section class="text-center">
  ...
  <!-- Section heading -->
  <h1 class="h1-responsive font-weight-bold text-center">MARCENARIA</h1>
  <!-- Section description -->
...
@foreach ( $registro as $valor )
    ...
    <div class="bloco">
        <div>
            <img  class="imagem rounded float-left img-fluid" src="{{asset('img/carros/motor.jpg')}} ">
        </div>
        ...
        <div class="empresa">
            ...
            <div>
                <h5>{{ $valor->descricao }}</h5>
            </div>
            <div>TEL: (41) 99999-9999</div>
            <div class="conhecer">
                <div>


                <a class="btn btn-primary" href="/empresa/{{ $valor->nome }}">CONHECER EMPRESA</a>
                </div>
            </div>
        </div>
    </div>
