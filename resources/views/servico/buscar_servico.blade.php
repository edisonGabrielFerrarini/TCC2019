...
<section class="text-center">
  ...
  <!-- Section heading -->
  <h2 class="h1-responsive font-weight-bold text-center"> BUSCAR SERVIÇOS </h2>
  <!-- Section description -->
  <p class="grey-text text-center w-responsive mx-auto mb-5">serviços que foram encontrados</p>


    @if($registro[0] == null)

        <h2>Não foi possivel encontra este serviço.</h2>
